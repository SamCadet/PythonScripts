...
# linkverification.py - attempts to download every linked page on the page

# answer - https://github.com/IFinners/automate-the-boring-stuff-projects/blob/master/Chapter%2011/link_verifier.py
